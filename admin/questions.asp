  ...
  <body>
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Quiz {<%=QuizTitle%>} Question Management</h1>
			<a href="questions.asp?QD=<%=strID%>&Pages=Add" class="btn btn-info"><span class="glyphicon glyphicon-plus"></span> Add a question</a>
          </div>
          <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
